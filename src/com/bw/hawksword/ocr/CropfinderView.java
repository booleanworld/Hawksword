 ...
 */
public final class CropfinderView extends View {
	...
	public CropfinderView(Context context, AttributeSet attrs) {
		super(context, attrs);
...
//		}
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultText != null) {
			...
			previewFrame = getFramingRectInPreview();
		...
		if( ( CropfinderView.frameColor == Color.GREEN || CropfinderView.frameColor == Color.RED || count == 1)) {
			try {
				if(count == 1) {
					Thread.sleep(1000);
					count = 0;
					...
					CropfinderView.frameColor = Color.WHITE;
					CropfinderView.cornerColor = Color.WHITE;
					count++;
					postInvalidate();
				}
